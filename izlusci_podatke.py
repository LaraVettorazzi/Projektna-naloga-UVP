...
def najdi_url(recept: str):
    vzorec = re.compile(r"<a href=(?P<url>.+?) class=", re.DOTALL)
...
def izlusci_podatke(recept: str):
    ...
    if najdba:
        ...
        slovar["hranilna_vrednost"] = hranilna_vrednost_v_kcal(
            najdba["hranilna_vrednost"]
        )
